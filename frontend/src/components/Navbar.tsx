      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <Link to="/" className="flex items-center space-x-3 group">
            <img src="/assets/branding/logo.jpeg" alt="Red Eagle Logo" className="w-12 h-12 rounded-lg object-contain transform group-hover:scale-105 transition-transform duration-300 shadow-sm bg-white" />
          ...
          <div className="px-4 py-4 space-y-2">
            {navLinks.map((link) => (
              <Link
                ...
                className={`block px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${location.pathname === link.path
                    ? "text-red-600 bg-red-50"
                    : "text-gray-700 hover:text-red-600 hover:bg-red-50"
                  }`}
              >
