      ...
      <section className="relative py-20 bg-gradient-to-br from-red-600 to-red-700 text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-red-100 max-w-3xl mx-auto">
            Red Eagle Public School - Guidelines for maintaining discipline and
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    All students and parents are required to read and adhere to
                    the school rules and regulations. Violation of any rule may
                    result in disciplinary action including expulsion,
                    suspension, or rustication. For any clarifications, please
            ...
            <CardContent className="p-8">
              <div className="space-y-4">
                {[
                  ...
                  "Each student should carry the School Diary to School everyday with his photograph and complete details.",
                  ...
                  <div
                    key={idx}
                    className="flex items-start space-x-3 p-4 bg-gray-50 rounded-lg hover:bg-red-50 transition-colors duration-200"
                  >
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    The School reserves the right to suspend or take
                    disciplinary action against a student whose progress is
                    unsatisfactory or whose conduct is harmful to other
                    students.
                  </p>
                </div>
                <div className="flex items-start space-x-3 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                  <AlertCircle className="w-6 h-6 text-yellow-600 flex-shrink-0 mt-1" />
                  <p className="text-gray-700 leading-relaxed">
                    No valuables like expensive watches, mobiles, i-pods,
                    i-pads, surplus money may be brought to school.
                  </p>
                </div>
                <div className="flex items-start space-x-3 p-4 bg-red-50 rounded-lg border border-red-200">
                  <XCircle className="w-6 h-6 text-red-600 flex-shrink-0 mt-1" />
                  <p className="text-gray-700 leading-relaxed font-semibold">
                    Mobiles once confiscated, no claim will be entertained. The
                    school phone is available for all students in cases of
                    emergency.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-8 p-6 bg-green-50 rounded-lg border-2 border-green-200">
                ...
                <div className="space-y-3 text-gray-700">
                  <p className="leading-relaxed">
                    <strong>Classes I-VIII:</strong> It is compulsory for
                    students to maintain 80% attendance during the entire
                    academic session so that they are eligible to appear for
                    their Final Assessments.
                  </p>
                  <p className="leading-relaxed">
                    <strong>Classes IX-XII:</strong> Students must have an
                    average of 80% attendance before the examination. This
                    percent can however be relaxed on medical grounds and the
                    Principal's decision is final.
                  </p>
                  <p className="leading-relaxed font-semibold text-green-700">
                    ⭐ A certificate of merit will be given to students with
                    100% attendance.
                  </p>
                </div>
              </div>
          ...
          <Card className="border-none shadow-lg bg-blue-50 border-blue-200">
            <CardContent className="p-8">
              <div className="mb-6 p-4 bg-white rounded-lg border border-blue-200">
                <p className="text-gray-700 leading-relaxed">
                  A student returning to school after a contagious/infectious
                  disease should produce a Doctor's certificate permitting him
                  fit to attend school. Students suffering from the following
                  diseases must observe the prescribed period of Quarantine
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {[
                  ...
                  {
                    disease: "Cholera",
                    period: "Till the child is completely well",
                  },
                  {
                    disease: "Measles",
                    period: "2 weeks after the rashes disappear",
                  },
                  {
                    disease: "Mumps",
                    period: "Until the swelling is gone (about 1 month)",
                  },
                  { disease: "Whooping Cough", period: "6 weeks" },
                  { disease: "Jaundice", period: "6 weeks" },
                  {
                    disease: "Swine Flu",
                    period: "Till the time the Doctor specifies fit",
                  },
                ].map((item, idx) => (
                  <div
                    key={idx}
      ...
      <section className="py-16 bg-gradient-to-br from-red-600 to-red-700 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-red-100 mb-8">
            For any questions regarding rules and regulations, please contact
            the Red Eagle Public School office
          </p>
